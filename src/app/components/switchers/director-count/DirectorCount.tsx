...
import { setCount } from '@/redux/slices/directorsFilterSlice';

export default function DirectorCount() {
    const t = useTranslations('Components.filmcount');
    const dispatch = useDispatch();

    const count = useSelector((state: RootState) => state.directorsFilter.count);
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem('count-d-filter');
