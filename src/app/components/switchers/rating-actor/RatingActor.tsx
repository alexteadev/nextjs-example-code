...
import { setRating } from '@/redux/slices/actorsFilterSlice';
import { useDispatch, useSelector } from 'react-redux';

export default function RatingActor() {
    const t = useTranslations('Components.rating');
    const dispatch = useDispatch();

    const rating = useSelector((state: RootState) => state.actorsFilter.rating);
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem('rating-a-filter');
